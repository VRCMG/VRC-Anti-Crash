...
namespace RubyButtonAPI
{
    ...
    public class QMButtonBase
    {
        ...
        {
            button.GetComponent<MonoBehaviourPublicIPointerEnterHandlerIEventSystemHandlerIPointerExitHandlerTeStTeBoStBoUnique>().field_Public_String_0 = buttonToolTip;
            button.GetComponent<MonoBehaviourPublicIPointerEnterHandlerIEventSystemHandlerIPointerExitHandlerTeStTeBoStBoUnique>().field_Public_String_1 = buttonToolTip;
        }
    ...
    public class QMStuff
    {
        ...
        private static MonoBehaviourPublicObAuSpObBoSpGaBoInSpUnique quickmenuInstance;

        // Internal cache of the VRCUiManager
        private static MonoBehaviourPublicObTrStTrSiTeSiObGaAnUnique vrcuimInstance;
        ...
        public static MonoBehaviourPublicObTrStTrSiTeSiObGaAnUnique GetVRCUiMInstance()
        {
            if (vrcuimInstance == null)
            {
                vrcuimInstance = MonoBehaviourPublicObTrStTrSiTeSiObGaAnUnique.prop_MonoBehaviourPublicObTrStTrSiTeSiObGaAnUnique_0;
            }
